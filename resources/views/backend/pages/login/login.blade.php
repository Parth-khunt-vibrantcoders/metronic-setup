        ...
        <div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
            ...
            <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                ...
                <a href="#" class="text-center pt-2">
                    <img src="{{  asset('public/backend/media/logos/logo.png') }}" class="max-h-75px" alt="" />
                </a>
                <!--end::Logo-->
                <!--begin::Aside body-->
                <div class="d-flex flex-column-fluid flex-column flex-center">
                    ...
                    <div class="login-form login-signup pt-11">
                        <!--begin::Form-->
                        <form class="form" id="sign-up-form" method="POST" action="{{ route('sign-up-user') }}">
                            @csrf
                            <!--begin::Title-->
                            <div class="text-center pb-8">
                            ...
                            <!--begin::Form group-->
                            <div class="form-group">
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text"  placeholder="Mobile No" name="mobile_no" autocomplete="off" />
                            </div>
                            <!--end::Form group-->
                            <!--begin::Form group-->
                            <div class="form-group">
