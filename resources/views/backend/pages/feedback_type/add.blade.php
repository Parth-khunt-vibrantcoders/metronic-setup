      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
               ...
               <!--begin::Form-->
               <form class="form" id="add-feedback-type" method="POST" action="{{ route('add-save-feedback-type') }}" >
                  @csrf
                  <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Feedback Type
                                <span class="text-danger">*</span></label>
                                <input type="text" name="feedback_type" class="form-control" placeholder="Please enter feedback type" >
                            </div>
                        </div>
